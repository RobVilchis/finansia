      ...
      <Flex justify="between" align="center" gap="2">
        ...
        >
          <Select.Trigger variant="soft"
            className="text-slate-600! dark:text-slate-300! bg-slate-100! dark:bg-slate-800! font-normal!"
          />
          <Select.Content
          >
        ...
        <Flex gap="3" align="center">
          ...
          <Button
            ...
            className="cursor-pointer! text-slate-600! dark:text-slate-300! bg-slate-100! dark:bg-slate-800! font-normal!"
          >
